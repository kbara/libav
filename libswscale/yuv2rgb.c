                                     ...
                                     int contrast, int saturation)
{
    ...
    c->yuv2rgb_y_coeff   = (int16_t)roundToInt16(cy * (1LL << 13));
    c->yuv2rgb_y_offset  = (int16_t)roundToInt16(oy * (1LL << 9));
    c->yuv2rgb_v2r_coeff = (int16_t)roundToInt16(crv * (1LL << 13));
    c->yuv2rgb_v2g_coeff = (int16_t)roundToInt16(cgv * (1LL << 13));
    c->yuv2rgb_u2g_coeff = (int16_t)roundToInt16(cgu * (1LL << 13));
    c->yuv2rgb_u2b_coeff = (int16_t)roundToInt16(cbu * (1LL << 13));

    //scale coefficients by cy
    crv = ((crv * (1LL << 16)) + 0x8000) / cy;
    cbu = ((cbu * (1LL << 16)) + 0x8000) / cy;
    cgu = ((cgu * (1LL << 16)) + 0x8000) / cy;
    cgv = ((cgv * (1LL << 16)) + 0x8000) / cy;
