                              ...
                              int rgba_map[4])
{
    ...
    switch (fmt) {
    case AV_PIX_FMT_BGR444: ((uint16_t*)(dst + y*dst_linesize))[x] = ((r >> 4) * (1 << 8)) | ((g >> 4) * (1 << 4)) | (b >> 4); break;
    case AV_PIX_FMT_RGB444: ((uint16_t*)(dst + y*dst_linesize))[x] = ((b >> 4) * (1 << 8)) | ((g >> 4) * (1 << 4)) | (r >> 4); break;
    case AV_PIX_FMT_BGR555: ((uint16_t*)(dst + y*dst_linesize))[x] = ((r >> 3) * (1 << 10)) | ((g >> 3) * (1 << 5)) | (b>>3); break;
    case AV_PIX_FMT_RGB555: ((uint16_t*)(dst + y*dst_linesize))[x] = ((b >> 3) * (1 << 10)) | ((g >> 3) * (1 << 5)) | (r>>3); break;
    case AV_PIX_FMT_BGR565: ((uint16_t*)(dst + y*dst_linesize))[x] = ((r >> 3) * (1 << 11)) | ((g >> 2) * (1 << 5)) | (b>>3); break;
    case AV_PIX_FMT_RGB565: ((uint16_t*)(dst + y*dst_linesize))[x] = ((b >> 3) * (1 << 11)) | ((g >> 2) * (1 << 5)) | (r>>3); break;
    case AV_PIX_FMT_RGB24:
    case AV_PIX_FMT_BGR24:
        v = (r * (1 << (rgba_map[R] * 8))) + (g * (1 << (rgba_map[G] * 8))) + (b * (1 << (rgba_map[B] * 8)));
